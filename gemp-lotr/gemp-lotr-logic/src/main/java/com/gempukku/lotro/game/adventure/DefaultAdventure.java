...
public class DefaultAdventure implements Adventure {
    ...
    @Override
    public GameProcess getStartingGameProcess(Set<String> players, PlayerOrderFeedback playerOrderFeedback, PregameSetupFeedback pregameSetupFeedback, long seedToResolveBiddingTie) {
        return new MappingPreBidGameProcess(players, playerOrderFeedback, pregameSetupFeedback, seedToResolveBiddingTie);
    }
